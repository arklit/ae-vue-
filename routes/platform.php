...
use App\Orchid\Screens\ProductSubCategory\ProductSubCategoryListScreen;
//use-place
...
OrchidHelper::setAdminRoutes(OrchidRoutes::PRODUCT->value, ProductListScreen::class, ProductEditScreen::class);
OrchidHelper::setAdminRoutes(OrchidRoutes::PRODUCT_CATEGORY->value, ProductCategoryListScreen::class);
OrchidHelper::setAdminRoutes(OrchidRoutes::PRODUCT_SUB_CATEGORY->value, ProductSubCategoryListScreen::class);
//route-place
